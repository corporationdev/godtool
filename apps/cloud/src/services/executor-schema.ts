...
export const openapi_oauth_session = pgTable(
...
export const mcp_oauth_session = pgTable(
  "mcp_oauth_session",
  {
    id: text("id").notNull(),
    scope_id: text("scope_id").notNull(),
...
export const google_discovery_source = pgTable(
...
export const google_discovery_binding = pgTable(
...
export const google_discovery_oauth_session = pgTable(
...
export const raw_source = pgTable(
  "raw_source",
  {
    id: text("id").notNull(),
    scope_id: text("scope_id").notNull(),
