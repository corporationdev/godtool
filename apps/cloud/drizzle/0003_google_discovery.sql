...
CREATE TABLE "google_discovery_composio_session" (
	...
	"session" jsonb NOT NULL,
	"created_at" timestamp NOT NULL,
	CONSTRAINT "google_discovery_composio_session_scope_id_id_pk" PRIMARY KEY("scope_id","id")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "google_discovery_composio_session_scope_id_idx" ON "google_discovery_composio_session" USING btree ("scope_id");
