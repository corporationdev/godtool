...
export const openapi_oauth_session = sqliteTable(
...
export const mcp_oauth_session = sqliteTable(
  "mcp_oauth_session",
  {
    id: text("id").notNull(),
    scope_id: text("scope_id").notNull(),
...
export const google_discovery_oauth_session = sqliteTable(
...
export const raw_source = sqliteTable(
  "raw_source",
  {
    id: text("id").notNull(),
    scope_id: text("scope_id").notNull(),
